...
namespace Rubbish.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserID,RouteNumber")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserID,RouteNumber")] Employee employee)
        {
            if (ModelState.IsValid)
            {
